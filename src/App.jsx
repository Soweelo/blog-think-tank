...
function App() {
    ...
    const [accountContent, setAccountContent] = useState(1);//1 is for post, 2 for the brands, 3 for brandform (displays instead of brandslist,and default 0 is for accountParams
    const [brandContent, setBrandContent] = useState([]);
    const [accountBrandForm, setAccountBrandForm] = useState(0); // 1 is for  editing 0 for creating new brand
